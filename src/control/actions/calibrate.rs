...
impl Calibrate {
    ...
    pub fn at_place_zone_ground() -> Self {Self::from_mode(CalibrateMode::PlaceZoneGround)}
    pub fn at_place_zone_stack() -> Self {Self::from_mode(CalibrateMode::PlaceZoneStack)}
...
impl Action for Calibrate {
    fn start(&mut self) {
        ROBOT.get_stm32_controller().set_yaw_servo(self.arm_rotation.to_angle());
