use crate::control::{
    actions::{calibrate_placement::CalibratePlacement, calibrate_source::CalibrateSource, rotate_arm::ArmRotationPreset},
    landmark::Landmark,
...
pub fn calibrate_at_final_processing_zone_1() -> Sequence {
...
pub fn calibrate_at_final_processing_zone_2() -> Sequence {
